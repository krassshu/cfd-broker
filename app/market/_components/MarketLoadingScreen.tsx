...
/** Full-screen loading overlay shown until first WS connection. Never reappears after disconnect. */
export default function MarketLoadingScreen() {
    const wsConnected = useMarketStore((s) => s.wsConnected);
    const hasConnected = useRef(false);
    const [phase, setPhase] = useState<"loading" | "fadeout" | "gone">("loading");

    useEffect(() => {
        if (wsConnected && !hasConnected.current) {
